    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-8 p-2">
        {users.map((user, index) => (
          ...
          <div
            key={user.id}
            className="flex items-center justify-around p-4 rounded-lg shadow-md dark:shadow-white/10 bg-gradient-to-tr from-slate-300/85 dark:from-sky-600 dark:to-sky-400 dark:bg-gradient-to-tr hover:scale-105 transition-all cursor-pointer"
          >
            <img
