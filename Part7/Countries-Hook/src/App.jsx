  ...
  return (
    <div className=''>
      <div className=' relative w-full h-full'>
        ...
        <div className=" absolute bg-[url('/fondo.webp')] inset-0 bg-cover bg-center w-full blur-md grayscale-50"></div>
        ...
        <form className='max-w-6xl mx-auto pb-10' onSubmit={fetch}>
          <StarBorder
            as="div"
            className="w-full"
            color="white"
