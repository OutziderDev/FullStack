const Aside = () => {
  return (
    <>
      <div className="w-full md:w-2/5 h-full p-4">
        ...
        <form className="mt-3 w-full">
          ...
          <div className="mb-3">
            ...
            <input type="text" id="weather" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="sunny" required />
          </div>
          <div>
